...
class MsgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create msg" do
    assert_difference("Msg.count") do
      post msgs_url, params: { msg: { body: @msg.body, project_id: @msg.project_id, title: @msg.title } }
    end
  ...
  test "should update msg" do
    patch msg_url(@msg), params: { msg: { body: @msg.body, project_id: @msg.project_id, title: @msg.title } }
